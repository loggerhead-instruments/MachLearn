...
for root, dirs, files in os.walk(r'D:\Large_Sliced_Files'):
    for file in files:
        # Gets full path of wav
        wav_path = os.path.join(root, file)
        print(wav_path)

        # if file size is at least 1 byte (deals with end of file error)
        if os.path.getsize(wav_path) > 1:
            ...
            plt.imsave(r'C:\Users\Austin\Documents\Academics\NCF\Semester_2\Loggerhead\practice\large_spec\\' + file[:-4]+".png", spectrogram)